...
input int PrimaryStoploss=150;
input int TrailStoploss=80;
...
int OnInit()
{
   ...
   buyTrail=new BuyFixTrail();
   buyTrail.Init(MagicNumber,symbol,timeFrame,TrailStoploss);
   
   sellTrail=new SellFixTrail();
   sellTrail.Init(MagicNumber,symbol,timeFrame,TrailStoploss);
   return(0);
}
...
void OnTimer()
{
   ...
   expert.Init(MagicNumber,symbol,PERIOD_CURRENT,money.GetLotsWith(FixMarginLevel),Threashold,PrimaryStoploss);
   expert.Main();
