...
//----------------------------------------------------------------------------------------------------
class PeakFrontActiveWave:public ActiveWaveBase
{
public:
...
class PeakFrontDownUpActiveWave:public PeakFrontActiveWave
{
protected:
...
//----------------------------------------------------nearest active wave-----------------------------
class PeakFrontUpDownActiveWave:public PeakFrontActiveWave
{
protected:
